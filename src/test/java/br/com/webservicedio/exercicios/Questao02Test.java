...
class Questao02Test {
    ...
    private Questao02 question2;
    private final Faker faker = new Faker(new Locale("pt", "BR"));

    @BeforeEach
    void setup() {
        question2 = new Questao02();
    }
    ...
    @Test
    void hasNoAdmin() {
        StepVerifier.create(question2.contarAdmins(generateUsers((long) faker.number().randomDigitNotZero(), false)))
    ...
    void hasXAdmins() {
        ...
        StepVerifier.create(question2.contarAdmins(Stream.concat(noAdminUsers.stream(), adminUsers.stream()).toList()))
                .recordWith(ArrayList::new)
                .thenConsumeWhile(actual -> true)
